...
import {white, purple500, blue500, green400, orange500} from 'material-ui/styles/colors';
...
class OptionsBar extends React.Component {
   ...
   */
    nameFieldChangeHandler(e, newValue) {
        this.props.dispatch(CA.setCanvasNameAndPersist(this.props.currentCanvas, newValue))
        ...
        if (this.props.canvas) {
            ...
            if (this.props.canvas[RC.CANVAS_USERS]) {
                ...
                Object.keys(this.props.canvas[RC.CANVAS_USERS]).forEach((uid) => {
                    ...
                    userDivs.push(
                        <IconButton tooltip={userEmail} touch={true} tooltipPosition="bottom-center" key={userEmail}>
                            <Avatar color={white} backgroundColor={COLORS[currColorIndex]} style={styles.avatar} size={30}>
                                {userEmail[0]}
                            </Avatar>
                        </IconButton>
                    );
            ...
            <div>
                <Box style={styles.box} col={9} sm={12} md={9}>
                    <Paper style={styles.paper} zDepth={1}>
                        <TextField style={styles.modelName} id="text-field-default" defaultValue={canvasName} onChange={this.nameFieldChangeHandler}/>
                        <span style={styles.optionBtnGroup}>
                            ...
                            <ShareCanvasModal/> {userDivs}
                        </span>
                    </Paper>
                </Box>
                <Snackbar autoHideDuration={2000} message="Name change saved" onRequestClose={this.handleSnackbarRequestClose} open={this.state.snackbarOpen}/>
            </div>
        );
    }
}
